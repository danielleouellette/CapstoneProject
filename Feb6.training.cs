...
namespace __Feb6
{
    public partial class Feb6
    {
        public const string RetrainFilePath =  @"C:\Users\DOuel\OneDrive\Desktop\INFT3000\sentimentLabelledSentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.5112673F,L2Regularization=0.2972567F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
